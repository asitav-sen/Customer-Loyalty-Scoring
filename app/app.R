...
server <- function(input, output) {
    ...
    scatterplotServer("customersscatter",xval=scatterdata$repscore, yval=scatterdata$count, 
                      cval=scatterdata$repcat, xtitle="Repeat Purchase Index", ytitle="Customers")
    ...
    scatterplotServer("transactionscatter",xval=scatterdata$repscore, yval=scatterdata$trans, 
                      cval=scatterdata$repcat, xtitle="Repeat Purchase Index", ytitle="Transactions")
    ...
    scatterplotServer("revenuescatter",xval=scatterdata$repscore, yval=scatterdata$sales, 
                      cval=scatterdata$repcat, xtitle="Repeat Purchase Index", ytitle="Revenue")
    ...
    lineplotServer("sowbyrepcat",xval=sowrep$monthid, yval=sowrep$SoW, cval=sowrep$repcat.x, xtitle="Months", ytitle="Share of Wallet")
    ...
    # Server functions for tab-customers
    scatterplotServer("cvicustomersscatter",xval=valscatterdata$valscore, yval=valscatterdata$count, 
                      cval=valscatterdata$valcat, xtitle="Customer Value Index", ytitle="Customers")
    
    
    infocardServer("cvicustomerlow",Value= valdeltamaxdata[valdeltamaxdata$valcat=="grey",]$customers,
                   Title="Low Index", Stat=paste0(valdeltamaxdata[valdeltamaxdata$valcat=="grey",]$deltacustomer*100," %"), 
                   Description="MoM Change", Icon=icon("meh"), BGC="secondary",
                   Icon_bg="gray 900")
    
    infocardServer("cvicustomermedium",Value= valdeltamaxdata[valdeltamaxdata$valcat=="blue",]$customers,
                   Title="Medium Index", Stat=paste0(valdeltamaxdata[valdeltamaxdata$valcat=="blue",]$deltacustomer*100," %"), 
                   Description="MoM Change", Icon=icon("smile-beam"), BGC="secondary",
                   Icon_bg="info")
    
    
    infocardServer("cvicustomerhigh",Value= valdeltamaxdata[valdeltamaxdata$valcat=="green",]$customers,
                   Title="High Index", Stat=paste0(valdeltamaxdata[valdeltamaxdata$valcat=="green",]$deltacustomer*100," %"), 
                   Description="MoM Change", Icon=icon("grin-alt"), BGC="secondary",
                   Icon_bg="success")
    
    # Server functions for tab-transactions
    scatterplotServer("cvitransactionscatter",xval=valscatterdata$valscore, yval=valscatterdata$trans, 
                      cval=valscatterdata$valcat, xtitle="Customer Value", ytitle="Transactions")
    
    
    infocardServer("cvitransactionlow",Value= valdeltamaxdata[valdeltamaxdata$valcat=="grey",]$transactions,
                   Title="Low Index", Stat=paste0(valdeltamaxdata[valdeltamaxdata$valcat=="grey",]$deltatransaction*100," %"), 
                   Description="MoM Change", Icon=icon("meh"), BGC="secondary",
                   Icon_bg="gray 900")
    
    infocardServer("cvitransactionmedium",Value= valdeltamaxdata[valdeltamaxdata$valcat=="blue",]$transactions,
                   Title="Medium Index", Stat=paste0(valdeltamaxdata[valdeltamaxdata$valcat=="blue",]$deltatransaction*100," %"), 
                   Description="MoM Change", Icon=icon("smile-beam"), BGC="secondary",
                   Icon_bg="info")
    
    
    infocardServer("cvitransactionhigh",Value= valdeltamaxdata[valdeltamaxdata$valcat=="green",]$transactions,
                   Title="High Index", Stat=paste0(valdeltamaxdata[valdeltamaxdata$valcat=="green",]$deltatransaction*100," %"), 
                   Description="MoM Change", Icon=icon("grin-alt"), BGC="secondary",
                   Icon_bg="success")
    
    # Server functions for tab-revenue
    scatterplotServer("cvirevenuescatter",xval=valscatterdata$valscore, yval=valscatterdata$sales, 
                      cval=valscatterdata$valcat, xtitle="Customer Value Index", ytitle="Revenue")
    
    
    infocardServer("cvirevenuelow",Value= valdeltamaxdata[valdeltamaxdata$valcat=="grey",]$sales,
                   Title="Low Index", Stat=paste0(valdeltamaxdata[valdeltamaxdata$valcat=="grey",]$deltasales*100," %"), 
                   Description="MoM Change", Icon=icon("meh"), BGC="secondary",
                   Icon_bg="gray 900")
    
    infocardServer("cvirevenuemedium",Value= valdeltamaxdata[valdeltamaxdata$valcat=="blue",]$sales,
                   Title="Medium Index", Stat=paste0(valdeltamaxdata[valdeltamaxdata$valcat=="blue",]$deltasales*100," %"), 
                   Description="MoM Change", Icon=icon("smile-beam"), BGC="secondary",
                   Icon_bg="info")
    
    
    infocardServer("cvirevenuehigh",Value= valdeltamaxdata[valdeltamaxdata$valcat=="green",]$sales,
                   Title="High Index", Stat=paste0(valdeltamaxdata[valdeltamaxdata$valcat=="green",]$deltasales*100," %"), 
                   Description="MoM Change", Icon=icon("grin-alt"), BGC="secondary",
                   Icon_bg="success")
    # Server function for second row of data
    
    lineplotServer("cvicustomersmonthly",xval=valdeltadata$monthid, yval=valdeltadata$customers, cval=valdeltadata$valcat, xtitle="Months", ytitle="Customers")
    lineplotServer("cvitransactionmonthly",xval=valdeltadata$monthid, yval=valdeltadata$transactions, cval=valdeltadata$valcat, xtitle="Months", ytitle="Transactions")
    lineplotServer("cvirevenuemonthly",xval=valdeltadata$monthid, yval=valdeltadata$sales, cval=valdeltadata$valcat, xtitle="Months", ytitle="Revenue")
    ...
    lineplotServer("cvisowbyrepcat",xval=sowval$monthid, yval=sowval$SoW, cval=sowval$valcat.x, xtitle="Months", ytitle="Share of Wallet")
